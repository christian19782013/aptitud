...
public class PerfilController implements Serializable {
    ...
    @EJB
    private ec.ruiztello.aptitud_catalogos.PerfilFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle01").getString("PerfilCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle01").getString("PerfilUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle01").getString("PerfilDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Perfil getPerfil(java.math.BigDecimal id) {
